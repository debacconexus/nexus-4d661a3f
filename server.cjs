...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "PLD Inclusive Education Implementation Nexus";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Educator PLD Participant";
process.env.TABLE_NAME = process.env.TABLE_NAME || "educator_pld_participant_records";
'use strict';
